...
function structureDate() {
    ...
    for(var i = 0;i<data.jointApplicantName.length;i++){
        ...
        // if(jointApplicant.jointApplicantName == null || jointApplicant.jointApplicantName == "" || jointApplicant.jointApplicantName == undefined){
        //     Feng.info("请填写姓名！");
        //     return ;
        // }
...
function addJointTable(OPTYPENUM,RECYEAR,RECNUM,tableId) {
    ...
    var str = '<tbody id="'+tbodyId+'">' +
        ...
        '                                            <button class="btn btn-danger" type="button" style="font-size: 15px;margin: 0px;float: right;" onclick="deleteUpload('+tbodyId+')">-</button></td>' +
        '                                    </tr>' +
        '                                    <tr class="tableTrClass">' +
        '                                        <td colspan="3">姓名</td>' +
        ...
        '                                                        <option value="4">未成年子女</option>' +
        '                                                        <option value="5">父子</option>' +
        '                                                        <option value="6">父女</option>' +
        '                                                        <option value="7">母子</option>' +
        '                                                        <option value="8">母女</option>' +
        '                                                        <option value="9">媳妇</option>' +
        '                                                        <option value="10">女婿</option>' +
        '                                            </select>' +
        '                                         </td>' +
